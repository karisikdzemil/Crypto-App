...
export default function ListItem({ data, i, favoriteBtn }) {
  ...
  return (
    <li className="text-white w-full h-[40px] relative border-gray-500 rounded-md p-2 px-5 flex gap-3 justify-between items-center hover:bg-[#1E2329] cursor-pointer">

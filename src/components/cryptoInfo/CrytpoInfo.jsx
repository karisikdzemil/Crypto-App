...
export default function CryptoInfo( {data} ) {
  ...
  return (
    <section className="w-full min-h-[100vh] bg-[#0B0E11] p-10 px-2 flex flex-col md:flex-row items-center justify-evenly flex-wrap">
      ...
      <div className="sm:w-112 w-full min-h-[40vh] flex flex-col justify-center items-start p-5">
        <InfoBuyCrypto />
                ...
                <ul className="w-full min-h-40 border-2 mt-5 bg-[#1E2329] border-slate-700 p-5 rounded-md flex flex-col items-center gap-3">

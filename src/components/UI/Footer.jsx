...
export default function Footer() {
  return (
    <footer className="w-full h-[40vh] bg-slate-800 flex justify-between items-center flex-col">
      <div className="p-10">
        <h1 className="text-3xl text-white text-center">Try demo trading</h1>
        <h2 className="text-2xl text-yellow-400 text-center">Become a pro</h2>
        <img
        ...
        <div className="w-full flex gap-5 h-10 justify-center items-center">
            <h1 className="text-yellow-400 text-2xl font-bold">Crypto</h1>
